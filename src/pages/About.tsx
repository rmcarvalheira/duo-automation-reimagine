          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6">
                <p className="body-md text-gray-700">
                  Fundada em 2010, a Duo Automation começou com foco em desenvolver soluções específicas para os 
                  desafios do setor sucroenergético brasileiro. Ao longo dos anos, expandimos nosso portfólio de produtos 
                  para atender diversas necessidades da agroindústria.
                </p>
                <p className="body-md text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white shadow-md rounded-lg border border-gray-100">
                <div className="text-3xl text-duo-yellow font-bold mb-2">10+</div>
