...
const productData = {
  'robo-slim': {
    ...
    specifications: [
      { name: 'Dimensões', value: '120 x 40 x 35 cm' },
      { name: 'Peso', value: '25 kg' },
      { name: 'Alimentação', value: '220V trifásico' },
      { name: 'Consumo', value: '3.5 kWh' },
      { name: 'Interface', value: 'Touch screen 7"' },
      { name: 'Conectividade', value: 'Wi-Fi, Ethernet' },
    ]
  },
  'robo-eva': {
    name: 'Robô EVA',
    ...
    specifications: [
      { name: 'Sistema de movimento', value: 'Eixos X, A, B, C e D' },
      { name: 'Cabeçote', value: 'Carretel duplo' },
      { name: 'Base', value: 'Fixada no centro das caixas' },
      { name: 'Tempo médio de limpeza', value: '8-12 horas por evaporador' },
      { name: 'Precisão', value: '0.1mm' },
      { name: 'Interface', value: 'Painel de controle touch' },
    ]
  },
  'duo-connect': {
    name: 'Duo Connect',
    ...
    specifications: [
      { name: 'Sensores', value: 'Alta precisão industrial' },
      { name: 'Escala Visual', value: '0 a 50 mm' },
      { name: 'Transmissão', value: 'Wireless LoRa' },
      { name: 'Alcance', value: 'Até 15 km em linha de visão' },
      { name: 'Armazenamento', value: 'Cloud com backup local' },
      { name: 'APIs', value: 'REST para integração com sistemas existentes' },
    ]
  },
  'robo-picker': {
    name: 'Robô Picker',
    ...
    specifications: [
      { name: 'Capacidade', value: '720 sacos/hora' },
      { name: 'Precisão de pesagem', value: '±10g' },
      { name: 'Peso do saco', value: '50kg standard' },
      { name: 'Potência', value: '12 kW' },
      { name: 'Dimensões', value: '8.5 x 4.2 x 3.5 m' },
      { name: 'Conectividade', value: 'Ethernet/Wi-Fi para relatórios na nuvem' },
    ]
  },
};
      ...
      <section className="bg-duo-blue text-white py-12">
        <div className="container">
          <div className="flex items-center mb-8">
            <Link 
              to="/produtos" 
              className="flex items-center text-gray-300 hover:text-duo-yellow transition-colors"
            >
