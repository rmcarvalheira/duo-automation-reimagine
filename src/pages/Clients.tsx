        ...
        <div className="container">
          ...
          <div className="mb-16">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
              {clients.map(client => <div key={client.id} className="p-4 flex items-center justify-center h-20">
                  {client.logo ? <img src={client.logo} alt={`Logo ${client.name}`} className="max-h-16 max-w-full object-contain" /> : <span className="text-lg font-medium text-gray-700 text-center">{client.name}</span>}
                </div>)}
            </div>
          </div>
          
          <h2 className="heading-lg text-duo-blue mb-8 text-center">Resultados alcançados</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="bg-duo-blue p-8 text-white">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-gray-300">Implementação do Robô Slim para automação completa do chapisco das moendas, eliminando a presença humana em ambiente insalubre.</p>
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="p-4 border border-gray-200 rounded-lg text-center">
                      ...
                      <p className="text-gray-600">Redução de uso de eletrodo</p>
                    </div>
                    <div className="p-4 border border-gray-200 rounded-lg text-center">
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg text-center">
                      ...
                      <p className="text-gray-600">Redução de gastos com contratação de serviços de caldeiraria</p>
                    </div>
                    <div className="p-4 border border-gray-200 rounded-lg text-center">
                      <p className="text-3xl font-bold text-duo-blue mb-2">0,7%</p>
                      <p className="text-gray-600">Redução da umidade do bagaço aumentando eficiência da caldeira</p>
                    </div>
                  </div>
