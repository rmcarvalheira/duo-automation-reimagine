    ...
    <>
      ...
      `}>
        <div className="flex flex-col space-y-4 p-6">
          <Link to="/sobre" className="py-3 text-lg font-medium text-duo-blue border-b border-gray-200" onClick={closeMenu}>
            {t('navbar.aboutDuo')}
          </Link>
          <div className="py-3 text-lg font-medium text-duo-blue border-b border-gray-200">
          ...
          <Link to="/solucoes" className="py-3 text-lg font-medium text-duo-blue border-b border-gray-200" onClick={closeMenu}>
            {t('navbar.solutions')}
          </Link>
          <Link to="/contato" className="py-3 text-lg font-medium text-duo-blue border-b border-gray-200" onClick={closeMenu}>
            {t('navbar.contact')}
          </Link>
          <Button asChild className="w-full mt-6 bg-duo-yellow text-duo-blue hover:bg-duo-yellow/90 font-bold">
